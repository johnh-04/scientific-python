...
print(np.exp(arr))  # Output: [1. 4.81047738 23.14069263] (exponential of each element)
print(np.log(arr + 1))  # Output: [0. 0.94421571 1.42108041] (natural logarithm of each element)
...
print(np.ceil(arr))  # Output: [0. 2. 4.] (ceiling of each element)
